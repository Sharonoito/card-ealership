...
export default async function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 font-sans selection:bg-emerald-100">
      {/* Decorative Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[10%] -right-[5%] h-[500px] w-[500px] bg-emerald-50 rounded-full blur-3xl opacity-60" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="mb-10 text-center">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-[2rem] bg-slate-950 shadow-2xl shadow-emerald-200/50 rotate-3 group">
            <svg
              ...
              className="h-8 w-8 text-emerald-400 group-hover:scale-110 transition-transform"
            >
          ...
          <h1 className="text-4xl font-black text-slate-900 tracking-tighter uppercase">
            Portal <span className="text-emerald-500 italic font-serif lowercase tracking-normal">Login.</span>
          </h1>
