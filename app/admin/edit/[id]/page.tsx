      ...
      <main className="max-w-4xl mx-auto px-6 py-16 lg:py-24">
        ...
        <div className="mb-16">
          ...
          <h1 className="text-6xl font-black text-slate-900 tracking-tighter leading-[0.85] mb-8">
            Modify <br />
            <span className="text-emerald-500 italic font-serif lowercase">
              {car.year} {car.model}.
            </span>
          </h1>
        ...
        <div className="relative">
          ...
          <div className="absolute -top-12 -left-12 h-64 w-64 bg-emerald-50 rounded-full blur-3xl opacity-50 -z-10" />
