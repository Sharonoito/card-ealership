      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100 py-6 px-6">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="h-2 w-2 rounded-full bg-[#0071d2] animate-pulse" title="System Active" />
          </div>
        </div>
      </nav>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 lg:py-24">
        ...
        <div className="mb-16">
          ...
          <h1 className="text-6xl font-black text-slate-900 tracking-tighter leading-[0.85] mb-8">
            Register <br />
            <span className="text-[#0071d2] italic font-serif lowercase">New Vehicle.</span>
          </h1>
        ...
        <div className="relative">
          ...
          <div className="absolute -top-12 -right-12 h-64 w-64 bg-[#0071d2]/5 rounded-full blur-3xl opacity-50 -z-10" />
